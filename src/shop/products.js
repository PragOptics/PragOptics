...
export const SOFTWARE = [
  {
    ...
    tagline: 'Cloud storage + API, for any app.',
    subtitle: 'The optional subscription that plugs into every PragOptics app — cloud storage plus the API-backed features we build in. The apps download free; this adds the server side: sync, storage, and API functions.',
    availability: 'available',
    access: 'subscription',
    ...
    features: [
      ...
      'API-backed features across every app',
  ...
  },
  {
    ...
    category: 'software',
    name: 'PragOptics',
    tagline: 'One engine for your entire front end.',
    subtitle: 'A full production studio: grab any element on a live canvas and shape it in place, or drop into raw code with a real repository tree. Websites, web apps, and code notebooks — one engine, AI assistance built in, and everything you make exports free.',
