...
Before the first license, your environment needs a licensing account. Opening it is one click by the team's owner or an admin; it uses the billing address you already gave, and nothing is charged for opening it. It is the record your licenses are held under.

## Which license does what

```flow
Exchange Online | A mailbox: mail, calendar and contacts, on the web, on a phone and in Outlook. The one to pick when a person needs an address at your domain and nothing else.
Microsoft 365 Business Basic | The mailbox plus Teams and the web versions of Word, Excel and PowerPoint, with OneDrive storage.
Microsoft 365 Business Standard | Business Basic plus the Office apps installed on the desktop.
